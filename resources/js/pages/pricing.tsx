...
export default function Pricing() {
    ...
    return <LandingLayout>
        <div className="flex flex-col gap-6 items-center py-12 w-full mx-auto px-8 @container
            ...
            <h2 className="text-foreground text-2xl @sm:text-4xl font-semibold text-center text-balance">Simple Plan,
                Transparent Pricing</h2>
            <p className="text-muted-foreground text-balance text-md @sm:text-lg text-center">Choose the plan that works
                best for you.</p>
