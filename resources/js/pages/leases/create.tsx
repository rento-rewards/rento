...
import ProvinceInput from '@/components/pages/province-input';
...
export default function LeaseCreate() {
    const { data, errors, setData, post, processing } = useForm<App.Data.LeaseData>({
        address_line_1: '',
        address_line_2: null,
        city: '',
        province: '',
        ...
        lease_start_date: '',
        rent_amount: 0,
        monthly_due_date: 1, // Default to the 1st of the month
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <form
                ...
                gap-4 overflow-x-auto rounded-xl p-4 w-full max-w-screen-md mx-auto"
                onSubmit={(e) => {
                    e.preventDefault();
                    post('/leases');
                }}
