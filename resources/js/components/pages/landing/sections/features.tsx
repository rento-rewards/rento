...
export default function FeaturesSection() {
    return <section className="bg-linear-to-b to-background from-muted">
        <div className="py-12">
            <div className="mx-auto w-full max-w-screen-xl px-8">
                <div>
                    ...
                    <p className="text-muted-foreground mb-12 mt-4 text-balance text-lg">Turn every rent payment into progress toward better credit and more opportunities.</p>
                </div>
